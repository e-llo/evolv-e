class Carnivoro extends Organismo{
    ...
    constructor(x, y, raio, vel_max, forca_max, cor, raio_deteccao, energia_max, taxa_gasto_energia, cansaco_max, tempo_vida_min, tempo_vida_max){
        super(x, y, raio, vel_max, forca_max, cor, raio_deteccao, energia_max, taxa_gasto_energia, cansaco_max, tempo_vida_min, tempo_vida_max); // referenciando o construtor da classe mãe
